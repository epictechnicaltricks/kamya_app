            ...
            child:Column(
              ...
              child:Container(
                ...
                Align(
                  ...
                  child: Text(product_desc,  textAlign: TextAlign.justify,

                      style: TextStyle(fontSize: 16,color:theme_color.text_color)),
                      ...
                      ElevatedButton(
                          onPressed: () {
                            setState(() {
                              ...
                              tappedIndex=index;
                              get_varient_data(product_string[index].product_varient_id);
                            });
                            },
                          child: Text(product_string[index].varient_name),

                          style: ElevatedButton.styleFrom(
                              primary: tappedIndex == index ? Color(0xff28276B) : Color(0xffD6C9AE) ,
                              shape: StadiumBorder()),
                      ),
                      ),
                      );
                ...
                Align(
                  ...
                  child: Container(
                    margin: const EdgeInsets.only(top: 5.0,left:20.0),
                    child: Text('Price',
                        style: TextStyle(fontSize: 16,color:theme_color.black)),
                  ),
                ),
                Align(
                  alignment: Alignment.centerLeft,
                  child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween, // use
                      children:[
                        Container(
                            margin: const EdgeInsets.only(top: 0.0,left:20.0),
                            child: Row(children:[
                              Text('Rs.',
                                  style: TextStyle(fontSize: 20,color:theme_color.button_color)),
                              Text(varient_price,
                                  style: TextStyle(fontSize: 20,color:theme_color.button_color)),
                              Text(' Rs.',
                                  style: TextStyle(fontSize: 20,color:theme_color.light_grey)),
                              Text(varient_mrp,
                                  style: TextStyle(decoration: TextDecoration.lineThrough,fontSize: 20,color:theme_color.light_grey)),
                             /* Container(
                                width: 100,
                                child:  CircleAvatar(
                                  backgroundColor: Colors.transparent,
  ...
  get_product_detail(String product_id) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        product_string = productlist.map<product_detail_list>(
                (json) => product_detail_list.fromJson(json)).toList();
