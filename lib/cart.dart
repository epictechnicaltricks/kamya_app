...
class _cartState extends State<cart> {
            ...
            children: [
              Center(
                child:Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/cart-big.png"), // <-- BACKGROUND IMAGE
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  child:ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      orderdata.add(place_order_model(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Container(
                                  margin: const EdgeInsets.only(
                                      left: 20, top:25, right: 30, bottom: 0),
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  TextButton(
                                      onPressed: () {
                                        delete_cart(cart_string[index].cart_id);
                              ...
                              children: <Widget>[
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                                ...
                                                children:<Widget>[
                                                  GestureDetector(
                                                    onTap: () {
                                                      Navigator.push(
                                                        context,
                                                        MaterialPageRoute(builder: (context) => product_detail( cart_string[index].product_id)),
                                                      );
                                                    ...
                                                    Container(
                                                      ...
                                                      child:Text(
                                                        cart_string[index].product_name,
                                              ...
                                              Row(
                                                children:<Widget>[
                                                  Container(
                                                    ...
                                                    child:
                                                    Text(
                                                      cart_string[index].varient_name,
                                              ...
                                              Row(
                                                children:<Widget>[
                                                  Container(
                                                    ...
                                                    margin: const EdgeInsets.only(
                                                        left: 3, top: 0, right: 1, bottom: 0),

                                                    child: Text(
                                                      'Rs.'+cart_string[index].varient_price+'.00',
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      'Rs.'+cart_string[index].varient_mrp+'.00',
                                                      textAlign: TextAlign.right,
                                                      style: TextStyle(
                                                  ...
                                                  Container(
                                                    ...
                                                    child: CircleAvatar(
                                                      ...
                                                      radius: 20,
                                                      child:  IconButton(
                                                        icon: Icon(Icons.remove,color: _quantityController[index].text!="1"?theme_color.dark_green:theme_color.light_grey,),
                                                        onPressed: () {
                                                    ...
                                                    decoration: new BoxDecoration(
                                                      ...
                                                      border: new Border.all(
                                                        color: _quantityController[index].text!="1"?theme_color.dark_green:theme_color.light_grey,
                                                        width: 1.0,
                                                      ),
                                                    ),
                                                  ),
                                                  ...
                                                  Container(
                                                    ...
                                                    child:  CircleAvatar(
                                                      ...
                                                      IconButton(
                                                        ...
                                                        onPressed: () {
                                                          _addQuantity(index);
                                                          add_qty(cart_string[index].cart_id);
                                    ...
                                    Row(
                                      children: [
                                        Dash(length: MediaQuery.of(context).size.width-30, dashColor:theme_color.light_grey),
                                      ],
                                    ),
                                  ],
                                ),
                    ...
                    children: <Widget>[
                      GestureDetector(
                        ...
                        child:  Container(
                          ...
                          child:  Text('Apply Promotion Code',
                            style: TextStyle(
                              color: theme_color.button_color,
                              fontSize: 15,
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => promocode_screen()
                              ));
                          },
                        child:  Container(
                          height: 50,
                          padding: const EdgeInsets.only(
                              left: 10, top:16, right: 10, bottom: 10),
                          child:  Text('${promocode_string.length} Promos',
                            style: TextStyle(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Align(
                        ...
                        child:Text(Sub_total,style: TextStyle(fontSize: 16,color: Color(0xffBBAD92),fontWeight: FontWeight.w800),),),
                      //
                    ],
                  ),),
               /* Container(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Align(
                        alignment: Alignment.centerLeft,
                        child:Text('Discount',style: TextStyle(fontSize: 16,color: Color(0xffBBAD92),fontWeight: FontWeight.w800),),),
                      Text('₹ ${discount}',style: TextStyle(fontSize: 16,color: Color(0xffBBAD92),fontWeight: FontWeight.w800),),
                      //
                    ],
                  ),),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(total,style: TextStyle(fontSize: 20,color:  theme_color.button_color,fontWeight: FontWeight.w500),),
                      //
                    ],
                  ),),
                Padding(
                  ...
                  child:  InkWell(
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => checkout(orderdata,final_total)
                          ));
  ...
  update_total(){
    int sum_total=0;
    for (var i = 0; i < cart_string.length; i++) {
      sum_total += int.parse(_quantityController[i].text)*int.parse(cart_string[i].varient_price);
  ...
  total_cart() async {
    ...
    for (var i = 0; i < cart_string.length; i++) {
      ...
      print('qty${cart_string[i].qty}');
       sum_product += int.parse(cart_string[i].qty)*int.parse(cart_string[i].varient_price);
    }
