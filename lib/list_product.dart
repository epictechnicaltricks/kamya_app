...
class list_product extends StatefulWidget {
  String list_id;
  String list_name;
  list_product(this.list_id,this.list_name);
...
class _list_productState extends State<list_product> {
  ...
  var visible= [];
  var already_list_div=[];

  var add_to_list_div=[];
  var selected_varient = [];
  var list_status= [];
...
//  var dropdown = List<String>.filled(6,'Select Varient', growable: true);
      ...
      children: [
        ...
        Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("${widget.list_name} shopping List"),
                ...
                Container(
                  ...
                  child:ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if(product_string[index].list_status=='Already in list')
                        {
                          already_list_div[index]=true;
                          add_to_list_div[index]=false;
                        }
                      return Padding(
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                              ...
                                              children:<Widget>[
                                                GestureDetector(
                                                  onTap:(){
                                                    ...
                                                    already_list_div[index]=false;
                                                    add_to_list_div[index]=true;
                                            ...
                                            Visibility(visible:add_to_list_div[index],
                                            child: Row(
                                              children:<Widget>[
                                                Container(
                                                  ...
                                                  ElevatedButton(
                                                    ...
                                                    onPressed: () {
                                                      add_to_list(
                                                          selected_varient[index],
                                                          product_string[index]
                                                              .product_id,
                                                          index);
                                                      //visible[index]=true;
                                                        setState(() {
                                                        already_list_div[index] =
                                                        true;
                                                        add_to_list_div[index] =
                                                        false;
                                                      });
                                            ...
                                            Visibility(visible:already_list_div[index],
                                              child: Row(
                                                children:<Widget>[
                                                  Container(
  ...
  add_to_list(String varient_id,String product_id,int index) async {
    //showLoaderDialog(context);
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        Fluttertoast.showToast(
            msg: "List ${widget.list_name} Updated Successfully.",
      ...
      /*Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => list_product(widget.list_id, widget.list_name),
          ));
  */
        if( add_to_list_div[index]==false)
        {
         // add_to_list_div[index] = true;
        //  already_list_div[index] = false;
  ...
  set_qty() {
    for (var i = 0; i < product_string.length; i++) {
      ...
      selected_varient = List<String>.filled(product_string.length,product_string[i].varient_id, growable: true);
      list_status = List<String>.filled(product_string.length,'Add to list', growable: true);
      varient_price = List<String>.filled(product_string.length,product_string[i].varient_price, growable: true);
    }
  }

  get_product() async {
    print('Listidin_product${widget.list_id}');
   // showLoaderDialog(context);
    ...
    if (response.statusCode == 200) {
     // Navigator.pop(context);
      ...
      setState(() {
        ...
        product_string = productlist.map<product_list>(
                (json) => product_list.fromJson(json)).toList();
        visible = List.filled(product_string.length,false, growable: true);
        add_to_list_div = List.filled(product_string.length,true, growable: true);
        already_list_div = List.filled(product_string.length,false, growable: true);
                            ...
                            GestureDetector(
                              onTap:(){
                                ...
                                setState(() {
                                  ...
                                  selected_varient[index]=varient_string[i].varient_id;
